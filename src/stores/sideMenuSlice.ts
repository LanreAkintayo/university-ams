...
const initialState: SideMenuState = {
  menu: [
    ...
    // },
    {
      ...
      title: "Add Laboratory Asset",
    },
    {
      icon: "FileCheck2",
      pathname: "/product-grid",
      title: "View Laboratory Assets",
    },
    "LIBRARY",
    // {
    //   icon: "FileCheck2",
    ...
    {
      icon: "FileCheck2",
      pathname: "/add-library",
      title: "Add Library Assets",
    },
    {
      icon: "FileCheck2",
      pathname: "/library-grid",
      title: "View Library Assets",
    },
    // {
    //   icon: "FileCheck2",
    //   pathname: "/products",
...
const initialStateUser: SideMenuState = {
  menu: [
    "DASHBOARDS",
    // {
    //   icon: "FileCheck2",
...
export const sideMenuUserSlice = createSlice({
  name: "sideMenuUser",
...
export const selectSideMenuUser = (state: RootState) => state.sideMenuUser.menu;

// export default sideMenuUserSlice.reducer;
